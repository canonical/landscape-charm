...
class LandscapeHATest(IntegrationTest):
    ...
    def test_app_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-appserver", unit=0)
    ...
    def test_app_non_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-appserver", unit=1)
        self.environment.check_service("appserver", attempts=25, interval=1)
    ...
    def test_msg_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-msgserver", unit=0)
    ...
    def test_msg_non_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-msgserver", unit=1)
        self.environment.check_service("msgserver", attempts=25, interval=1)
    ...
    def test_ping_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-pingserver", unit=0)
    ...
    def test_ping_non_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-pingserver", unit=1)
        self.environment.check_service("pingserver", attempts=25, interval=1)
    ...
    def test_api_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-api", unit=0)
    ...
    def test_api_non_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-api", unit=1)
        self.environment.check_service("api", attempts=25, interval=1)
    ...
    def test_upload_leader_down(self):
        ...
        """
        self.environment.stop_landscape_service("landscape-package-upload")
